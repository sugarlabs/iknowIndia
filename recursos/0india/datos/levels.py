...
[
    ...
    (_('Bhubaneswar'), _("It's in %s") % _('Orissa')),
...
[
    ...
    (_('Pillani'), _("It's in %s") % _('Rajasthan')),
    ...
    (_('Orchna'), _("It's in %s") % _('Madhya Pradesh')),
    ...
    (_('Hirakud Dam'), _("It's in %s") % _('Orissa')),
    (_('Cuttak'), _("It's in %s") % _('Orissa')),
    (_('Paradwip'), _("It's in %s") % _('Orissa')),
    (_('Konarak'), _("It's in %s") % _('Orissa')),
    (_('Puri'), _("It's in %s") % _('Orissa')),
    (_('Gopalpur'), _("It's in %s") % _('Orissa')),
    ...
    (_('Malghat'), _("It's in %s") % _('Maharashtra')),
    ...
    (_('Bhadrachalan'), _("It's in %s") % _('Andhra Pradesh')),
    ...
    (_('Mamallpuram'), _("It's in %s") % _('Tamil Nadu')),
    (_('Chidambaram'), _("It's in %s") % _('Tamil Nadu')),
    (_('Mudumali'), _("It's in %s") % _('Tamil Nadu')),
